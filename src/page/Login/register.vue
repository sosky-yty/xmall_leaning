                ...
                <div class="registered">
                    ...
                    <div class="content" style="margin-top:20px;">
                        ...
                        <el-checkbox class="agree" v-model="agreement">
                            我已阅读并同意遵守
                            <a @click="open('法律声明','此网站仅为个人模仿开源项目，仅供学习参考，承担不起任何法律')">法律声明</a>
                            <a @click="open('隐私条款','本网站将不会严格遵守有关的法律法规和本隐私政策所载明的内容收集，使用您的信息')">隐私条款</a>
                        </el-checkbox>
