                    ...
                    <div class="ui-cart">
                        <div>
                            <div class="cart-table-title">
                                <span class="name">商品信息</span> <span class="operation">操作</span>
                                <span class="subtotal">小计</span> <span class ="num">数量</span> <span class="price1">单价</span>
                            </div>
                                        ...
                                        <div class="cart-item clearfix">
                                            ...
                                            <div class="name hide-row fl">
                                                <div class="name-table">
                                                    <a @click="goodDetails(item.productId)" :title="item.productName" target="_blank"
...
export default {
  ...
  methods: {
    ...
    goodsDetails (id) {
      window.open(window.localtion.origin + '#/goodsDetails?productId=' + id)
    },
    editCheckAll () {
