        ...
        <div class="container">
            <div class="siteinfo">
                <ul class="c0">
                    <h3 class="c1">订单服务</h3>
                    <ul>
                        <li class="c2"><router-link to="/"><a class="c3">购买指南</a></router-link></li>
                        <li class="c2"> <a class="c3" @click="open3">支付方式</a></li>
